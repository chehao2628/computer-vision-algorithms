...
Hao Che (uniID: u6548236)
"""
import cv2
import numpy as np
import matplotlib.pyplot as plt
# from Task1.harris import *
...
# Create a Gaussian filter with (3*sigma)*2+1 kernel size.The kernel size is at least 1.
